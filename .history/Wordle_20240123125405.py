...
def wordle():
    ...
    def enter_action(s):
        ...
        for inner in range(0,5):
            l1 = gw.get_square_letter(N_ROWS -(6-i), N_COLS - 5)
            l2 = gw.get_square_letter(N_ROWS -(6-i), N_COLS - 4)
            l3 = gw.get_square_letter(N_ROWS -(6-i), N_COLS - 3)
            l4 = gw.get_square_letter(N_ROWS -(6-i), N_COLS - 2)
            l5 = gw.get_square_letter(N_ROWS -(6-i), N_COLS - 1)
